...
export namespace SettingsHelpers {
    export function getSettingsFromEnvironment(): Partial<NoiaNodeSettings> {
        return {
            ...
            statisticsPath: process.env.NOIA_NODE_STATISTICS_PATH,
            ...
            sslPrivateKeyPath: process.env.NOIA_NODE_SSL_PRIVATE_KEY_PATH,
            sslCrtPath: process.env.NOIA_NODE_SSL_CRT_PATH,
            sslCrtBundlePath: process.env.NOIA_NODE_SSL_CRT_BUNDLE_PATH,
